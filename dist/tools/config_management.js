...
export async function handleConfigManagementTool(name, args) {
    ...
    try {
        switch (name) {
            ...
            case "update_configmap": {
                ...
                const mergedData = { ...(current.data || {}), ...(args.data || {}) };
            ...
            case "update_secret": {
                ...
                const mergedStringData = { ...(current.stringData || {}), ...(args.stringData || {}) };
